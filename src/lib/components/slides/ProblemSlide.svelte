<script lang="ts">
  ...
  const stats = [
    {
      n: "$62B",
      d: "in recoverable materials lost annually",
      sub: "$19B copper · $15B gold · $16B iron",
    },
    { n: "22%", d: "formally recycled", sub: "Declining to 20% by 2030" },
    {
      n: "1 in 3",
      d: "replaced devices still work",
      sub: "Discarded while functional",
    },
    {
      n: "87%",
      d: "drop in component lifecycles",
      sub: "From 30 years to under 4",
    },
  ];
</script>
...
<Slide bg={C.cream}>
  ...
  <Circ
    s={280}
    c={C.red}
    style="bottom: -120px; right: -80px; opacity: 0.06;"
  />
  <Pad>
